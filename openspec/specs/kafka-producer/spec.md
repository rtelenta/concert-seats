...
Provides a NestJS injectable `KafkaProducer` service that publishes `EventEnvelope` messages to Kafka topics with caller-supplied partition keys and injects W3C trace context into message headers for distributed tracing.
